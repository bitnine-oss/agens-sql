...
pkgdatadir = $(datadir)/json-c
pkgincludedir = $(includedir)/json-c
pkglibdir = $(libdir)/json-c
pkglibexecdir = $(libexecdir)/json-c
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = i386-unknown-netbsdelf6.0.1
host_triplet = i386-unknown-netbsdelf6.0.1
...
am__append_1 = libjson.la
am__append_2 = json.pc
subdir = .
...
am_libjson_la_rpath = -rpath $(libdir)
DEFAULT_INCLUDES = -I.
...
STRIP = strip
VERSION = 0.11
abs_builddir = /home/erh/json-c/json-c-0.11
abs_srcdir = /home/erh/json-c/json-c-0.11
abs_top_builddir = /home/erh/json-c/json-c-0.11
abs_top_srcdir = /home/erh/json-c/json-c-0.11
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
#libjsonx_includedir = $(libdir)/json-c-0.11
#
...
include ./$(DEPDIR)/json_c_version.Plo
include ./$(DEPDIR)/json_object.Plo
include ./$(DEPDIR)/json_object_iterator.Plo
include ./$(DEPDIR)/json_tokener.Plo
include ./$(DEPDIR)/json_util.Plo
include ./$(DEPDIR)/libjson.Plo
include ./$(DEPDIR)/linkhash.Plo
include ./$(DEPDIR)/printbuf.Plo
...
uninstall-local:
	...
	rm -rf "$(DESTDIR)${prefix}/include/json-c"
